...
PROJECT_NAME = GoldenAmi
EMAIL_FOR_NOTIFICATIONS = me@example.com
VPCID = vpc-12345678
TEST_SUBNET_ID = subnet-1234567890
TEST_SECURITY_GROUP_ID = sg-1234567890
TEST_EC2_INSTANCE_PROFILE = test-ec2-instance-profile
...
GOLDEN_AMI_SSM_PARAMETER_NAME = "/${PROJECT_NAME}/latest_golden_ami_id"
GOLDEN_AMI_SSM_PARAMETER_DESC = "The ami id of the latest golden ami"
...
usage:
	...
	@echo TEST_SECURITY_GROUP_ID = ${TEST_SECURITY_GROUP_ID}
...
deploy:
	...
	'ParameterKey=TestSecurityGroupId,ParameterValue=${TEST_SECURITY_GROUP_ID}' \
	'ParameterKey=TestEC2InstanceProfile,ParameterValue=${TEST_EC2_INSTANCE_PROFILE}' \
